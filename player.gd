...
func _ready():
	var ball: InventoryItem = load("res://inventory/items/ball.tres")
	var stick: InventoryItem = load("res://inventory/items/stick.tres")
	var bag: InventoryContainer = load("res://inventory/containers/nixie_pouch.tres")
